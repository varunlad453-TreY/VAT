...
def build_pdf(output_path: str):
    ...
    comparison_data = [
        [Paragraph("DIMENSION / TIER", th_style), Paragraph("PRE-PHASE 1 (TOY PROTOTYPE STATE)", th_style), Paragraph("POST-PHASE 1 (ENTERPRISE STABILIZED STATE)", th_style)],
        [
    ...
    db_details = [
        [Paragraph("COMPONENT", th_style), Paragraph("FILE PATH", th_style), Paragraph("TECHNICAL SPECIFICATION & ENTERPRISE CAPABILITY", th_style)],
        [
    ...
    worker_details = [
        [Paragraph("SUBSYSTEM", th_style), Paragraph("IMPLEMENTATION DETAILS", th_style), Paragraph("OPERATIONAL RESILIENCE METRIC", th_style)],
        [
    ...
    audit_map_data = [
        [Paragraph("OPERATIONAL ENTITY", th_style), Paragraph("TRUE SOURCE", th_style), Paragraph("PIPELINE / CONSUMER", th_style), Paragraph("INTEGRITY VERDICT", th_style)],
        [
    ...
    monorepo_details = [
        [Paragraph("WORKSPACE / PACKAGE", th_style), Paragraph("DIRECTORY PATH", th_style), Paragraph("ROLE & ARCHITECTURAL IMPLEMENTATION", th_style)],
        [
    ...
    test_matrix_data = [
        [Paragraph("VERIFICATION TARGET", th_style), Paragraph("COMMAND EXECUTED", th_style), Paragraph("EMPIRICAL RESULT", th_style), Paragraph("STATUS", th_style)],
        [
