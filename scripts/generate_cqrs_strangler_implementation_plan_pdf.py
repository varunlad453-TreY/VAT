...
def build_pdf(output_path: str):
    ...
    tier_ab_data = [
        [Paragraph("TIER / SUB-SYSTEM", th_style), Paragraph("TECHNOLOGY STACK", th_style), Paragraph("ARCHITECTURAL SPECIFICATION & OPERATIONAL BEHAVIOR", th_style)],
        [
    ...
    tier_cde_data = [
        [Paragraph("TIER / CAPABILITY", th_style), Paragraph("TECHNOLOGY STACK", th_style), Paragraph("TECHNICAL SPECIFICATION & ENTERPRISE INTEGRATION", th_style)],
        [
    ...
    frontend_pillars_data = [
        [Paragraph("PILLAR", th_style), Paragraph("TECHNOLOGY", th_style), Paragraph("ENGINEERING JUSTIFICATION & ARCHITECTURAL PATTERN", th_style)],
        [
