...
def build_pdf(output_path: str):
    ...
    reality_check_data = [
        [Paragraph("CHOKEPOINT / COMPONENT", th_style), Paragraph("FAILURE MECHANISM & ARCHITECTURAL ROOT CAUSE", th_style), Paragraph("BLAST RADIUS", th_style)],
        [
    ...
    blueprint_data = [
        [Paragraph("TIER / DOMAIN", th_style), Paragraph("TECHNOLOGY STACK", th_style), Paragraph("ARCHITECTURAL SPECIFICATION & SCALING PATTERN", th_style)],
        [
    ...
    frontend_data = [
        [Paragraph("FRONTEND PILLAR", th_style), Paragraph("TECHNOLOGY", th_style), Paragraph("ENGINEERING JUSTIFICATION & ARCHITECTURAL IMPLEMENTATION", th_style)],
        [
